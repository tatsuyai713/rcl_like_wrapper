...
bool ROSTypeImagePubSubEdge::init_config(const std::string &config_file_path)
{
  ...
  subscriber_ptr_ = create_subscription<sensor_msgs::msg::Image>(&sub_message_type_, subscribe_topic_name_, 10, std::bind(&ROSTypeImagePubSubEdge::callbackSubscribe, this, std::placeholders::_1));
